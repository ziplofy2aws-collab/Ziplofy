...
const STORAGE_KEY = 'informatic-theme-editor-settings-sheet-height';
const MIN_HEIGHT = 180;
const DEFAULT_HEIGHT = 420;

type InformaticThemeSettingsSheetProps = {
  children: ReactNode;
};
...
export function InformaticThemeSettingsSheet({ children }: InformaticThemeSettingsSheetProps) {
  ...
  return (
    <div
      ref={sheetRef}
      className="absolute inset-x-0 bottom-0 z-10 flex flex-col overflow-hidden border-t border-[#e1e1e1] bg-white shadow-[0_-4px_12px_rgba(0,0,0,0.08)]"
      style={{ height }}
    >
      <div
        role="separator"
