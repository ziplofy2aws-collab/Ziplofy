export const PENDING_PAYMENT_ERROR_EMAIL_SUBJECT =
  '[{{store_name}}] Pending payment couldn\'t be processed';
...
export function buildPendingPaymentErrorEmailHtml(variables: Record<string, string>): string {
...
export const PENDING_PAYMENT_ERROR_EMAIL_BODY = buildPendingPaymentErrorEmailHtml({
