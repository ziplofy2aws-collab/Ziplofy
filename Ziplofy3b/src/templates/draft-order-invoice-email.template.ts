export const DRAFT_ORDER_INVOICE_EMAIL_SUBJECT = 'Invoice #{{order_number}}';
...
export function buildSampleDraftOrderItemsHtml(): string {
  return [
...
export function buildDraftOrderTotalsHtml(options?: {
  subtotal?: string;
  discount?: string;
  discountCode?: string;
  shipping?: string;
...
export function buildDraftOrderInvoiceEmailHtml(variables: Record<string, string>): string {
...
export function getDraftOrderInvoiceEmailBodyTemplate(): string {
...
export const DRAFT_ORDER_INVOICE_EMAIL_BODY = getDraftOrderInvoiceEmailBodyTemplate();

export function formatDraftOrderCurrency(amount: number, currency = 'Rs.'): string {
