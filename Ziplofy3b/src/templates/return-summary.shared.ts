...
export function buildReturnItemRow(
  productName: string,
  quantity: number,
  price: string,
  subtitle?: string,
...
export function buildSampleReturnSummaryHtml(): string {
  return [
...
export function replaceReturnEmailVariables(
  template: string,
...
export const RETURN_EMAIL_DEFAULTS = {
  store_name: 'My Store',
  order_number: '9999',
  view_order_url: '#',
  store_url: '#',
