...
export const PENDING_PAYMENT_SUCCESS_EMAIL_SUBJECT =
  '[{{store_name}}] Payment processed successfully';
...
export function buildPendingPaymentSuccessEmailHtml(variables: Record<string, string>): string {
...
export const PENDING_PAYMENT_SUCCESS_EMAIL_BODY = buildPendingPaymentSuccessEmailHtml({
