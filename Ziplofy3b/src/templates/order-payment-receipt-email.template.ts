...
export const ORDER_PAYMENT_RECEIPT_EMAIL_SUBJECT = 'Payment receipt for order #{{order_number}}';
...
export function buildOrderPaymentReceiptEmailHtml(variables: Record<string, string>): string {
...
export function getOrderPaymentReceiptEmailBodyTemplate(): string {
...
export const ORDER_PAYMENT_RECEIPT_EMAIL_BODY = getOrderPaymentReceiptEmailBodyTemplate();
