export const READY_FOR_LOCAL_PICKUP_EMAIL_SUBJECT =
...
export function buildSamplePickupOrderItemsHtml(): string {
  return [
...
export function buildPickupOrderTotalsHtml(options?: {
  subtotal?: string;
  discount?: string;
  discountCode?: string;
  shipping?: string;
  shippingOriginal?: string;
...
export function buildReadyForLocalPickupEmailHtml(variables: Record<string, string>): string {
...
export function getReadyForLocalPickupEmailBodyTemplate(): string {
...
export const READY_FOR_LOCAL_PICKUP_EMAIL_BODY = getReadyForLocalPickupEmailBodyTemplate();
