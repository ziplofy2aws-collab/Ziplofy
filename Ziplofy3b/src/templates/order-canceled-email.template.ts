...
export const ORDER_CANCELED_EMAIL_SUBJECT = 'Your order was canceled';
...
export function buildOrderCanceledEmailHtml(variables: Record<string, string>): string {
...
export const ORDER_CANCELED_EMAIL_BODY = buildOrderCanceledEmailHtml({
