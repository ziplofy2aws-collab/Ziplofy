...
export const RETURN_REQUEST_APPROVED_EMAIL_SUBJECT = 'Your return was approved';

export function buildReturnRequestApprovedEmailHtml(variables: Record<string, string>): string {
...
export const RETURN_REQUEST_APPROVED_EMAIL_BODY = buildReturnRequestApprovedEmailHtml({
