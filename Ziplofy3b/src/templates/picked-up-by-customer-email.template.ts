...
export const PICKED_UP_BY_CUSTOMER_EMAIL_SUBJECT = 'Your order was picked up';
...
export function buildPickedUpByCustomerEmailHtml(variables: Record<string, string>): string {
...
export function getPickedUpByCustomerEmailBodyTemplate(): string {
...
export const PICKED_UP_BY_CUSTOMER_EMAIL_BODY = getPickedUpByCustomerEmailBodyTemplate();
