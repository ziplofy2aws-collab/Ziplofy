export const ORDER_LINK_EMAIL_SUBJECT = 'Your updated order link';
...
export function buildOrderLinkEmailHtml(variables: Record<string, string>): string {
...
export const ORDER_LINK_EMAIL_BODY = buildOrderLinkEmailHtml({
