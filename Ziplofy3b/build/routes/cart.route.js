...
const cart_recovery_controller_1 = require("../controllers/cart-recovery.controller");
...
exports.cartRouter.post('/store/:storeId/recovery-email', auth_middleware_1.protect, cart_recovery_controller_1.sendCartRecoveryEmail);
