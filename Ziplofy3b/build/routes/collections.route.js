...
exports.collectionsRouter.get("/theme-templates/store/:storeId", collections_controller_1.getCollectionThemeTemplates);
...
// DUPLICATE
exports.collectionsRouter.post("/:id/duplicate", collections_controller_1.duplicateCollection);
// UPDATE
