...
exports.ORDER_LOCALLY_DELIVERED_EMAIL_BODY = exports.ORDER_LOCALLY_DELIVERED_EMAIL_SUBJECT = void 0;
exports.buildOrderLocallyDeliveredEmailHtml = buildOrderLocallyDeliveredEmailHtml;
exports.getOrderLocallyDeliveredEmailBodyTemplate = getOrderLocallyDeliveredEmailBodyTemplate;
const ready_for_local_pickup_email_template_1 = require("./ready-for-local-pickup-email.template");
exports.ORDER_LOCALLY_DELIVERED_EMAIL_SUBJECT = 'Your order was delivered';
...
function buildOrderLocallyDeliveredEmailHtml(variables) {
...
<head>
  ...
  <title>Order locally delivered</title>
</head>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e5e5e5;">
          ...
          <tr>
            <td style="padding:32px;">
              <h1 style="margin:0 0 12px;font-size:24px;font-weight:600;color:#333333;line-height:1.3;">Your order was delivered</h1>
              <p style="margin:0 0 24px;font-size:14px;color:#717171;line-height:1.6;">Haven&rsquo;t received your order? <a href="mailto:{{support_email}}" style="color:#1990c6;text-decoration:none;">Let us know</a>.</p>
...
function getOrderLocallyDeliveredEmailBodyTemplate() {
    return buildOrderLocallyDeliveredEmailHtml({
...
exports.ORDER_LOCALLY_DELIVERED_EMAIL_BODY = getOrderLocallyDeliveredEmailBodyTemplate();
