...
exports.RETURN_REQUEST_APPROVED_EMAIL_BODY = exports.RETURN_REQUEST_APPROVED_EMAIL_SUBJECT = void 0;
exports.buildReturnRequestApprovedEmailHtml = buildReturnRequestApprovedEmailHtml;
const return_summary_shared_1 = require("./return-summary.shared");
exports.RETURN_REQUEST_APPROVED_EMAIL_SUBJECT = 'Your return was approved';
function buildReturnRequestApprovedEmailHtml(variables) {
    const returnSummaryHtml = variables.return_summary_html || (0, return_summary_shared_1.buildSampleReturnSummaryHtml)();
    return (0, return_summary_shared_1.replaceReturnEmailVariables)(`
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>Return request approved</title></head>
    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e5e5e5;">
        ...
        <tr><td style="padding:32px;">
          <h1 style="margin:0 0 12px;font-size:24px;font-weight:600;color:#333333;">Your return was approved</h1>
          <p style="margin:0 0 24px;font-size:14px;color:#717171;line-height:1.6;">Your return request has been approved. Follow the instructions below to complete your return.</p>
...
</body></html>`, variables, return_summary_shared_1.RETURN_EMAIL_DEFAULTS);
}
exports.RETURN_REQUEST_APPROVED_EMAIL_BODY = buildReturnRequestApprovedEmailHtml({
