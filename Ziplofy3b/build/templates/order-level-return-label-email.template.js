...
exports.ORDER_LEVEL_RETURN_LABEL_EMAIL_BODY = exports.ORDER_LEVEL_RETURN_LABEL_EMAIL_SUBJECT = void 0;
exports.buildOrderLevelReturnLabelEmailHtml = buildOrderLevelReturnLabelEmailHtml;
const return_summary_shared_1 = require("./return-summary.shared");
exports.ORDER_LEVEL_RETURN_LABEL_EMAIL_SUBJECT = 'Return label for order #{{order_number}}';
function buildOrderLevelReturnLabelEmailHtml(variables) {
...
exports.ORDER_LEVEL_RETURN_LABEL_EMAIL_BODY = buildOrderLevelReturnLabelEmailHtml({
