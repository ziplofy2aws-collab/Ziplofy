...
exports.RETURN_REQUEST_RECEIVED_EMAIL_BODY = exports.RETURN_REQUEST_RECEIVED_EMAIL_SUBJECT = void 0;
exports.buildReturnRequestReceivedEmailHtml = buildReturnRequestReceivedEmailHtml;
const return_summary_shared_1 = require("./return-summary.shared");
exports.RETURN_REQUEST_RECEIVED_EMAIL_SUBJECT = 'Return request received';
function buildReturnRequestReceivedEmailHtml(variables) {
    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e5e5e5;">
        ...
        <tr><td style="padding:32px;">
          <h1 style="margin:0 0 12px;font-size:24px;font-weight:600;color:#333333;">Your return request was sent</h1>
          <p style="margin:0 0 24px;font-size:14px;color:#717171;line-height:1.6;">Your return request was sent and is being reviewed. We&rsquo;ll email you once it&rsquo;s been completed.</p>
...
exports.RETURN_REQUEST_RECEIVED_EMAIL_BODY = buildReturnRequestReceivedEmailHtml({
