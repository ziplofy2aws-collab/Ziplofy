...
exports.ORDER_PAYMENT_RECEIPT_EMAIL_BODY = exports.ORDER_PAYMENT_RECEIPT_EMAIL_SUBJECT = void 0;
exports.buildOrderPaymentReceiptEmailHtml = buildOrderPaymentReceiptEmailHtml;
exports.getOrderPaymentReceiptEmailBodyTemplate = getOrderPaymentReceiptEmailBodyTemplate;
...
exports.ORDER_PAYMENT_RECEIPT_EMAIL_SUBJECT = 'Payment receipt for order #{{order_number}}';
...
function buildOrderPaymentReceiptEmailHtml(variables) {
    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e5e5e5;">
        ...
        <tr><td style="padding:32px;">
          <h1 style="margin:0 0 12px;font-size:24px;font-weight:600;color:#333333;">Your payment has been received</h1>
          <p style="margin:0 0 24px;font-size:14px;color:#717171;line-height:1.6;">A payment of {{amount_paid}} was applied to your order.</p>
...
function getOrderPaymentReceiptEmailBodyTemplate() {
    return buildOrderPaymentReceiptEmailHtml({
...
exports.ORDER_PAYMENT_RECEIPT_EMAIL_BODY = getOrderPaymentReceiptEmailBodyTemplate();
