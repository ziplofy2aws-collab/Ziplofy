...
exports.ORDER_REFUND_EMAIL_BODY = exports.ORDER_REFUND_EMAIL_SUBJECT = void 0;
exports.buildOrderRefundEmailHtml = buildOrderRefundEmailHtml;
exports.getOrderRefundEmailBodyTemplate = getOrderRefundEmailBodyTemplate;
const ready_for_local_pickup_email_template_1 = require("./ready-for-local-pickup-email.template");
exports.ORDER_REFUND_EMAIL_SUBJECT = 'Refund for order #{{order_number}}';
...
function buildOrderRefundEmailHtml(variables) {
...
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>Order refund</title></head>
    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e5e5e5;">
        ...
        <tr><td style="padding:32px;">
          <h1 style="margin:0 0 12px;font-size:24px;font-weight:600;color:#333333;">Your refund has been processed</h1>
          <p style="margin:0 0 24px;font-size:14px;color:#717171;line-height:1.6;">A refund of {{refund_amount}} has been issued for your order. It may take a few business days to appear on your statement.</p>
...
function getOrderRefundEmailBodyTemplate() {
    return buildOrderRefundEmailHtml({
...
exports.ORDER_REFUND_EMAIL_BODY = getOrderRefundEmailBodyTemplate();
