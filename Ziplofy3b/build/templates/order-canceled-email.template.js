...
exports.ORDER_CANCELED_EMAIL_BODY = exports.ORDER_CANCELED_EMAIL_SUBJECT = void 0;
exports.buildOrderCanceledEmailHtml = buildOrderCanceledEmailHtml;
const ready_for_local_pickup_email_template_1 = require("./ready-for-local-pickup-email.template");
exports.ORDER_CANCELED_EMAIL_SUBJECT = 'Your order was canceled';
...
function buildOrderCanceledEmailHtml(variables) {
    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e5e5e5;">
        ...
        <tr><td style="padding:32px;">
          <h1 style="margin:0 0 12px;font-size:24px;font-weight:600;color:#333333;">Your order was canceled</h1>
          <p style="margin:0 0 24px;font-size:14px;color:#717171;line-height:1.6;">Your order has been canceled. If you have questions about this cancellation, please contact us.</p>
...
exports.ORDER_CANCELED_EMAIL_BODY = buildOrderCanceledEmailHtml({
