...
exports.PICKED_UP_BY_CUSTOMER_EMAIL_BODY = exports.PICKED_UP_BY_CUSTOMER_EMAIL_SUBJECT = void 0;
exports.buildPickedUpByCustomerEmailHtml = buildPickedUpByCustomerEmailHtml;
exports.getPickedUpByCustomerEmailBodyTemplate = getPickedUpByCustomerEmailBodyTemplate;
const ready_for_local_pickup_email_template_1 = require("./ready-for-local-pickup-email.template");
exports.PICKED_UP_BY_CUSTOMER_EMAIL_SUBJECT = 'Your order was picked up';
...
function buildPickedUpByCustomerEmailHtml(variables) {
...
<head>
  ...
  <title>Picked up by customer</title>
</head>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e5e5e5;">
          ...
          <tr>
            <td style="padding:32px;">
              <h1 style="margin:0 0 12px;font-size:24px;font-weight:600;color:#333333;line-height:1.3;">Your order was picked up</h1>
              <p style="margin:0 0 24px;font-size:14px;color:#717171;line-height:1.6;">Thank you for picking up your order at {{pickup_location_name}}.</p>
...
function getPickedUpByCustomerEmailBodyTemplate() {
    return buildPickedUpByCustomerEmailHtml({
...
exports.PICKED_UP_BY_CUSTOMER_EMAIL_BODY = getPickedUpByCustomerEmailBodyTemplate();
