...
exports.ORDER_OUT_FOR_LOCAL_DELIVERY_EMAIL_BODY = exports.ORDER_OUT_FOR_LOCAL_DELIVERY_EMAIL_SUBJECT = void 0;
exports.buildOrderOutForLocalDeliveryEmailHtml = buildOrderOutForLocalDeliveryEmailHtml;
exports.getOrderOutForLocalDeliveryEmailBodyTemplate = getOrderOutForLocalDeliveryEmailBodyTemplate;
const shipping_confirmation_email_template_1 = require("./shipping-confirmation-email.template");
exports.ORDER_OUT_FOR_LOCAL_DELIVERY_EMAIL_SUBJECT = 'Your order is out for delivery';
...
function buildOrderOutForLocalDeliveryEmailHtml(variables) {
    const shipmentItemsHtml = variables.shipment_items_html || (0, shipping_confirmation_email_template_1.buildSampleShipmentItemsHtml)();
...
function getOrderOutForLocalDeliveryEmailBodyTemplate() {
...
exports.ORDER_OUT_FOR_LOCAL_DELIVERY_EMAIL_BODY = getOrderOutForLocalDeliveryEmailBodyTemplate();
