...
const blog_post_route_1 = require("./routes/blog-post.route");
const blog_tags_route_1 = require("./routes/blog-tags.route");
...
const gift_card_product_route_1 = require("./routes/gift-card-product.route");
...
const online_store_preferences_route_1 = __importDefault(require("./routes/online-store-preferences.route"));
...
const storefront_checkout_configuration_route_1 = require("./routes/storefront/storefront-checkout-configuration.route");
...
const blog_comment_route_1 = require("./routes/blog-comment.route");
...
app.use("/api/blog-posts", blog_post_route_1.blogPostRouter);
app.use("/api/blog-comments", blog_comment_route_1.blogCommentRouter);
...
app.use("/api/storefront/checkout-configuration", storefront_checkout_configuration_route_1.storeFrontCheckoutConfigurationRouter);
...
app.use("/api/gift-card-products", gift_card_product_route_1.giftCardProductRouter);
...
app.use("/api/online-store-preferences", online_store_preferences_route_1.default);
...
app.use("/api/storefront", storefront_sitemap_route_1.storefrontSeoRouter);
...
app.get('/robots.txt', storefront_robots_controller_1.getStorefrontRobots);
// Routes
app.get('/', (req, res) => {
    res.status(200).json({
