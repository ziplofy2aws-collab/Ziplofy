...
const membership_plan_route_1 = require("./routes/membership-plan.route");
...
const payment_provider_route_1 = require("./routes/payment-provider.route");
...
app.use("/api/payment-providers", payment_provider_route_1.paymentProviderRouter);
...
app.use("/api/membership-plans", membership_plan_route_1.membershipPlanRouter);
