...
exports.buildStoreSenderEmailVerificationUrl = buildStoreSenderEmailVerificationUrl;
exports.buildStoreSenderEmailVerificationEmail = buildStoreSenderEmailVerificationEmail;
const config_1 = require("../config");
function buildStoreSenderEmailVerificationUrl(token) {
    return `${config_1.config.clientUrl}/settings/notifications/verify-sender-email?token=${encodeURIComponent(token)}`;
}
function buildStoreSenderEmailVerificationEmail(params) {
