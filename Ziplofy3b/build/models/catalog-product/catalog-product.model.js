...
const CatalogProductSchema = new mongoose_1.Schema({
    catalogId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Catalog', required: true, index: true },
...
exports.CatalogProduct = mongoose_1.default.model('CatalogProduct', CatalogProductSchema);
