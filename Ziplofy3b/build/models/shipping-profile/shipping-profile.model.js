...
const ShippingProfileSchema = new mongoose_1.Schema({
    profileName: {
        type: String,
        required: true,
        trim: true,
...
exports.ShippingProfile = mongoose_1.default.models.ShippingProfile ||
    mongoose_1.default.model('ShippingProfile', ShippingProfileSchema);
