...
export const ADMIN_NAV_SEARCH_CATALOG: AdminNavSearchItem[] = [
  ...
  },
  {
    ...
    title: 'Products & catalog analytics',
    path: '/analytics/products',
    group: 'Analytics',
    navPath: ['Analytics'],
    keywords: ['sku', 'vendor', 'catalog', 'margin', 'collections'],
  },
  {
    ...
    group: 'Analytics',
    navPath: ['Analytics'],
    keywords: ['stock', 'on-hand', 'committed', 'cover', 'warehouse'],
  },
  {
    ...
    group: 'Analytics',
    navPath: ['Analytics'],
    keywords: ['customers', 'ltv', 'opt-in'],
  },
  {
    id: 'content-crm-analytics',
    title: 'Content / CRM analytics',
    path: '/analytics/content',
    group: 'Analytics',
    navPath: ['Analytics'],
    keywords: ['newsletter', 'contact form', 'blog', 'pages', 'crm'],
  },
  {
    id: 'live-view',
    title: 'Live view',
