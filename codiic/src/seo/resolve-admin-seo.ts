...
const ROUTE_RULES: RouteRule[] = [
  ...
  { test: (p) => p === '/orders/drafts/new', title: 'Create order' },
  ...
  { test: (p) => p === '/analytics/customers', title: 'Customer analytics' },
  { test: (p) => p === '/analytics/content', title: 'Content / CRM analytics' },
  { test: (p) => p === '/analytics/products', title: 'Products & catalog analytics' },
  { test: (p) => p === '/analytics/inventory', title: 'Inventory analytics' },
