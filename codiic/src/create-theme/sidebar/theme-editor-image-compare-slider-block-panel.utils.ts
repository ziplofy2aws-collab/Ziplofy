...
const FIELD_SORT: Record<string, number> = {
  ...
  sliderBorderThickness: 23,
  sliderBorderOpacity: 24,
  sliderBorderColor: 25,
  sliderCornerRadius: 26,
  sliderPaddingTop: 30,
...
export function comparisonSliderDefaultSettings(): Record<string, string | number | boolean> {
  return {
    ...
    sliderBorderThickness: 1,
    sliderBorderOpacity: 100,
    sliderBorderColor: 'default',
