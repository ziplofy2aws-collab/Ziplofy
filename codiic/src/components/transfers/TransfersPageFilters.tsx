...
export type TransferFilterTab = 'All' | 'Draft' | 'In progress' | 'Transferred';

interface TransfersPageFiltersProps {
  activeTab: TransferFilterTab;
  onTabChange: (tab: TransferFilterTab) => void;
  search: string;
  onSearchChange: (value: string) => void;
}

const FILTER_OPTIONS: TransferFilterTab[] = ['All', 'Draft', 'In progress', 'Transferred'];

const TransfersPageFilters: React.FC<TransfersPageFiltersProps> = ({
  activeTab,
  onTabChange,
  search,
  onSearchChange,
  ...
  return (
    <div className="flex items-center gap-2 border-b border-admin-border bg-admin-surface px-3 py-2.5">
      <div className="relative shrink-0" ref={filterRef}>
        ...
        {filterOpen ? (
          <div className="absolute left-0 top-full z-20 mt-1 min-w-[140px] overflow-hidden rounded-lg border border-admin-border bg-admin-surface py-1 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
...
export default TransfersPageFilters;
