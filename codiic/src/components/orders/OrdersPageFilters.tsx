  ...
  return (
    <div className={adminListFilterBarClass}>
      ...
      <button
        type="button"
        title="Edit columns"
        className="inline-flex shrink-0 items-center justify-center rounded-lg border border-admin-border bg-admin-surface p-1.5 text-admin-text-secondary transition-colors hover:bg-admin-row-hover"
      >
