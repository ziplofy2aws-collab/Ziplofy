...
import { poInputClass } from './purchase-order-ui.util';

export type PurchaseOrderFilterTab = 'All' | 'Draft' | 'Ordered' | 'Received';

interface PurchaseOrdersPageFiltersProps {
  activeTab: PurchaseOrderFilterTab;
  onTabChange: (tab: PurchaseOrderFilterTab) => void;
  search: string;
  onSearchChange: (value: string) => void;
}

const FILTER_OPTIONS: PurchaseOrderFilterTab[] = ['All', 'Draft', 'Ordered', 'Received'];

const PurchaseOrdersPageFilters: React.FC<PurchaseOrdersPageFiltersProps> = ({
  activeTab,
  onTabChange,
  search,
  onSearchChange,
    ...
    <div className="flex items-center gap-2 border-b border-gray-100 px-3 py-2">
      ...
      <div className="relative min-w-0 flex-1">
        ...
        <input
          ...
          className={`${poInputClass} py-1.5 pl-8 pr-3`}
        />
      </div>
    </div>
  );
...
export default PurchaseOrdersPageFilters;
