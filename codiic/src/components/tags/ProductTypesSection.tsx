    ...
    <>
      <SettingsPanel className="overflow-hidden p-0">
        <div className={tagSectionHeaderClass}>
          <h2 className="text-[13px] font-semibold text-admin-text">Your product types</h2>
          <p className="mt-1 text-[13px] text-admin-text-secondary">
            Types classify products at a high level (for example apparel vs. accessories) and often
            appear in admin filters and exports.
          </p>
        </div>
        ...
        <ProductTypesList tags={productTypes} loading={loading} onDeleteClick={handleDeleteClick} />
      </SettingsPanel>
