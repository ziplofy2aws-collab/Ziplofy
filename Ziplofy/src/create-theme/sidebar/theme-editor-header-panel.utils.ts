...
const HEADER_ELEMENT_EXCLUDED_KEYS = new Set(['searchPlaceholder', 'cartLabel']);
...
const FIELD_SORT: Record<string, number> = {
  ...
  topRowBackground: 60,
  topRowText: 61,
  bottomRowBackground: 62,
  bottomRowText: 63,
  cartBubbleStyle: 65,
  cartBubbleBackground: 66,
  cartBubbleText: 67,
