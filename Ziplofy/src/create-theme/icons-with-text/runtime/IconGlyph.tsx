...
export function IconGlyph({ icon, style }: Props) {
  const strokeWidth = useThemeIconStrokeWidth();
  const common = {
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
  ...
  switch (icon) {
      ...
      return (
        <svg {...common}>
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M12 3v18" stroke="currentColor" strokeWidth={strokeWidth} />
        </svg>
      );
    case 'truck':
      return (
    ...
    case 'gift':
      return (
        <svg {...common}>
          <rect x="4" y="10" width="16" height="10" rx="1" stroke="currentColor" strokeWidth={strokeWidth} />
          <path d="M12 10V20M4 10h16M8 10c0-2 1.5-4 4-4s4 2 4 4" stroke="currentColor" strokeWidth={strokeWidth} />
        </svg>
      );
    case 'eye':
    default:
