...
export function Faq({ sectionId = 'faq_section', templateId = 'index', placement = 'template' }: SectionRuntimeProps) {
  ...
  return (
    <section style={shell} {...editorAttrs(editorNodeId, 'FAQ', 'section')}>
              ...
              >
                ...
                >
                  <span
                    ...
                    {...editorAttrs(blockNodeId, 'Question', 'field', questionPath)}
                  >
                    {item.question}
                  </span>
                ...
                {open ? (
                  <div
                    ...
                    {...editorAttrs(blockNodeId, 'Answer', 'field', answerPath)}
                  >
