...
type HeroMediaBackgroundProps = {
  media1Url: string;
  media2Url: string;
  /** Used when no media URLs are set (e.g. bottom-aligned / marquee defaults). */
  fallbackUrl?: string;
};
...
/**
 * Full-bleed hero background: single image, 50/50 split when both medias are set, or fallback.
 */
