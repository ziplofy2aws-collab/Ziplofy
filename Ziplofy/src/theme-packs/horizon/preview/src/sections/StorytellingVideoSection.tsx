...
import { VideoStorytellingShirtsIllustration } from '../components/VideoStorytellingArt';
import {
...
} from '../lib/storytellingVideoStyles';
...
export function StorytellingVideoSection({
  ...
  return (
    <EditorSection nodeId={editorNodeId} label="Video">
      <section className={scopeClass} style={shell} data-section-type="storytelling-video">
        ...
        <div style={stage}>
          <div style={mediaShell}>
            <EditorField fieldPath={`${settingsBase}.coverImageUrl`} label="Cover image" as="div" style={mediaPanel}>
              {mediaContent}
