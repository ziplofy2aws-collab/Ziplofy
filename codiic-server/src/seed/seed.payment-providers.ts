...
const providers = [
  ...
  },
  {
    ...
    name: 'Bank transfer',
    description:
      'Let customers pay by transferring funds directly to your bank account. Orders are placed after checkout and must be approved once payment is received.',
  ...
  },
  {
    ...
    name: 'UPI ID',
    description:
      'Accept payments via UPI. Customers scan a QR code or pay to your UPI ID at checkout. Orders must be approved once payment is confirmed.',
    category: 'wallet' as const,
    supports3ds: false,
    paymentMethods: ['upi'],
    isTest: false,
  ...
  },
  {
    ...
    description:
      'Let customers pay in cash when their order is delivered. Activate COD to offer it as a payment option at checkout.',
    category: 'wallet' as const,
    supports3ds: false,
    paymentMethods: ['cod'],
    isTest: false,
