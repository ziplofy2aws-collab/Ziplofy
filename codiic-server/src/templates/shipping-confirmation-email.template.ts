export const SHIPPING_CONFIRMATION_EMAIL_SUBJECT =
  'A shipment from order #{{order_number}} is on the way';
...
function shipmentItemRow(productName: string, quantity: number, subtitle?: string): string {
  return `
    <tr>
...
export function buildSampleShipmentItemsHtml(): string {
  return [
...
export function buildShippingConfirmationEmailHtml(variables: Record<string, string>): string {
...
export function getShippingConfirmationEmailBodyTemplate(): string {
...
export const SHIPPING_CONFIRMATION_EMAIL_BODY = getShippingConfirmationEmailBodyTemplate();
