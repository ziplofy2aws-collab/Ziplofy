...
export const ORDER_LOCALLY_DELIVERED_EMAIL_SUBJECT = 'Your order was delivered';
...
export function buildOrderLocallyDeliveredEmailHtml(variables: Record<string, string>): string {
...
export function getOrderLocallyDeliveredEmailBodyTemplate(): string {
...
export const ORDER_LOCALLY_DELIVERED_EMAIL_BODY = getOrderLocallyDeliveredEmailBodyTemplate();
