...
export const ORDER_REFUND_EMAIL_SUBJECT = 'Refund for order #{{order_number}}';
...
export function buildOrderRefundEmailHtml(variables: Record<string, string>): string {
...
export function getOrderRefundEmailBodyTemplate(): string {
...
export const ORDER_REFUND_EMAIL_BODY = getOrderRefundEmailBodyTemplate();
