export const NEW_GIFT_CARD_EMAIL_SUBJECT = '{{store_name}} {{gift_card_amount}} gift card';
...
export function buildNewGiftCardEmailHtml(variables: Record<string, string>): string {
...
export function getNewGiftCardEmailBodyTemplate(): string {
...
export const NEW_GIFT_CARD_EMAIL_BODY = getNewGiftCardEmailBodyTemplate();
