...
export const RETURN_REQUEST_RECEIVED_EMAIL_SUBJECT = 'Return request received';

export function buildReturnRequestReceivedEmailHtml(variables: Record<string, string>): string {
...
export const RETURN_REQUEST_RECEIVED_EMAIL_BODY = buildReturnRequestReceivedEmailHtml({
