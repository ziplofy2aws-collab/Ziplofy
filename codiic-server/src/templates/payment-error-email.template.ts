export const PAYMENT_ERROR_EMAIL_SUBJECT = '[{{store_name}}] Payment couldn\'t be processed';
...
export function buildPaymentErrorEmailHtml(variables: Record<string, string>): string {
...
export const PAYMENT_ERROR_EMAIL_BODY = buildPaymentErrorEmailHtml({
